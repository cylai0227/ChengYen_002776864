...
public class CreateJPanel extends javax.swing.JPanel {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if(packageId.getText().isEmpty()||packageWt.getText().isEmpty()||custId.getText().isEmpty()||custName1.getText().isEmpty()){
    ...
    private void saveProductbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveProductbtnActionPerformed
        // TODO add your handling code here:
         if(productId1.getText().isEmpty()||productName1.getText().isEmpty()||productPrice1.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Don't accept empty value");
        } 
        
        
        int productId = Integer.parseInt(productId1.getText());
        String productName = productName1.getText();
        double productPrice = Double.parseDouble(productPrice1.getText());
        ...
        if(n%2==0){
            Product p = delPackage.addProduct();
            p.setPrice(productPrice*2);
            p.setProductId(productId);
            p.setProductName(productName);
        }else{
            Product p = delPackage.addProduct();
            p.setPrice(productPrice*3);
            p.setProductId(productId);
            p.setProductName(productName);
        }
